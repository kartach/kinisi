...
?>
	...
	<div class="panel-heading" role="tab" id="heading_<?php echo $item->id; ?>">
		<a class="<?php if($i!=0 || $params->get('collapsed') == 0) echo 'collapsed'; ?>" role="button" href="#collapse_<?php echo $module->id; ?>_<?php echo $item->id; ?>" data-toggle="collapse" data-parent="#accordion<?php echo $module->id; ?>" aria-expanded="false" aria-controls="heading_<?php echo $item->id; ?>">
	...
	<div id="collapse_<?php echo $module->id; ?>_<?php echo $item->id; ?>" class="panel-collapse collapse <?php if($params->get('collapsed')):?><?php if($i==0) echo 'in'; ?><?php endif;?>" role="tabpanel" aria-labelledby="#collapse_<?php echo $module->id; ?>_<?php echo $item->id; ?>">
