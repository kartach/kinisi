...
class Images extends Data
{
	...
	public static function getImageHtml($url, $alt = '', $title = '', $class = '', $caption = false, $in_div = true)
	{
		...
		return '<img' . $title . ' src="' . htmlspecialchars($url) . '" alt="' . htmlspecialchars($alt) . '" class="' . $img_class . '">';
	}
