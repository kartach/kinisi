...
?>
    <div class="os-gallery-album-tabs-main-<?php echo $galId?>">
        <span class="back-to-albums" style="display:none;"><?php echo $backText?></span>
        <div class="os-cat-tab-images" style="display:none">
            ...
            foreach($images as $catId => $catImages){
                ...
                <div id="cat-<?php echo $catId?>" class="album-block" data-cat-id="<?php echo $catId?>" data-end="<?php echo $numberImages?>" >
                    <?php
                    if($catImages){
                        foreach($catImages as $i => $image){
                            ...
                            ?>
                            <div class="img-block <?php echo $imageHover ?>-effect" <?php echo $styleImg?>>
                                <div class="os-gallery-album-<?php echo $catId?>">
        ...
        <script>
            (function () {
                var osGallery<?php echo $galId?> = function (container, params) {
                    ...
                    osg.init = function (){
                        ...
                        jQuerGall(container+" .album-block .img-block").css("width",imgBlockW+"%");
                        ...
                        //album click
                        jQuerGall(container+" .album-main-image").click(function(event) {
                            albumId = jQuerGall(this).data("cat-id");

                            var curCatId = jQuerGall("#cat-"+albumId).attr('data-cat-id');
                            jQuerGall("#load-more-<?php echo $galId?>").attr('data-cat-id', curCatId);
                            var curEnd = jQuerGall("#cat-"+albumId).attr('data-end');
                            if(curEnd != -1)
                            ...
                            jQuerGall(container+" .back-to-albums").data("cat-id", albumId);
                            //show album
                            jQuerGall(container+" .os-gallery-album-"+albumId).parent().fadeTo( "slow", 1 );
                            jQuerGall(container+" .os-gallery-album-"+albumId+","+container+" .back-to-albums").fadeTo( "slow", 1 );
                            jQuerGall("#load-more-<?php echo $galId?>").fadeTo( "slow", 1 );

                            //hide albums main image
                            jQuerGall(container+" .album-main-image").parent().hide();
                        });

                        jQuerGall(container+" .back-to-albums").click(function(event) {
                            //hide images
                            albumId = jQuerGall(this).data("cat-id");
                            jQuerGall(container+" .os-gallery-album-"+albumId).parent().hide();
                            jQuerGall(container+" .os-gallery-album-"+albumId+","+container+" .back-to-albums").hide();
                            jQuerGall("#cat-"+albumId+" .img-block").hide();
                            jQuerGall("#load-more-<?php echo $galId?>").hide();

                            //show albums
                            jQuerGall(container+" .album-main-image").parent().fadeTo( "slow", 1 );
                        });
            ...
            jQuery(window).on('load',function($) {
                var gallery = new osGallery<?php echo $galId?>(".os-gallery-album-tabs-main-<?php echo $galId?>",{
