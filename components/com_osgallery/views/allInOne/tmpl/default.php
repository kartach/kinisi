...
?>
    <div class="os-gallery-all-in-one-main-<?php echo $galId?>">
        <div class="os-cat-tab-images" style="display:none">
            ...
            foreach($images as $catId => $catImages){
                ...
                <div id="cat-<?php echo $catId?>" data-cat-id="<?php echo $catId?>" class="all-in-one-block">
                    <?php
                    if($catImages){
                            ...
                            <div class="img-block <?php echo $imageHover ?>-effect" <?php echo $styleImg ?>>
                                <a class="os_fancybox-<?php echo $catId.'" ';?>"
                                    ...
                                    <div class="os-gallery-caption">
                                        ...
                                        if($currentCatParams->get("categoryShowTitleCaption",1)){
        ...
        <script>
            ...
            jQuery(window).on('load',function($) {
                var gallery = new osGallery<?php echo $galId?>(".os-gallery-all-in-one-main-<?php echo $galId?>",{
