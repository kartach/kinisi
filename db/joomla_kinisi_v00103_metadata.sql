...
ALTER TABLE `bc73q_rokcommon_configs`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `bc73q_roksprocket_items`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `bc73q_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=985;
...
ALTER TABLE `bc73q_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10401;
...
ALTER TABLE `bc73q_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1069;

ALTER TABLE `bc73q_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;

ALTER TABLE `bc73q_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=405775;
...
ALTER TABLE `bc73q_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;

ALTER TABLE `bc73q_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
