...
--
-- Indexes for table `bc73q_gsd`
--
ALTER TABLE `bc73q_gsd`
  ADD PRIMARY KEY (`id`),
  ADD KEY `state` (`state`),
  ADD KEY `thing_plugin` (`thing`,`plugin`);
...
--
-- Indexes for table `bc73q_plg_easyfrontendseo`
--
ALTER TABLE `bc73q_plg_easyfrontendseo`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `bc73q_sefaliases`
--
ALTER TABLE `bc73q_sefaliases`
  ADD PRIMARY KEY (`id`),
  ADD KEY `alias` (`alias`);

--
-- Indexes for table `bc73q_sefexts`
--
ALTER TABLE `bc73q_sefexts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bc73q_sefexttexts`
--
ALTER TABLE `bc73q_sefexttexts`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bc73q_seflog`
--
ALTER TABLE `bc73q_seflog`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bc73q_sefmoved`
--
ALTER TABLE `bc73q_sefmoved`
  ADD PRIMARY KEY (`id`),
  ADD KEY `old` (`old`);

--
-- Indexes for table `bc73q_sefurls`
--
ALTER TABLE `bc73q_sefurls`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sefurl` (`sefurl`),
  ADD KEY `origurl` (`origurl`,`Itemid`),
  ADD KEY `idx_updates` (`locked`,`flag`);

--
-- Indexes for table `bc73q_sefurlword_xref`
--
ALTER TABLE `bc73q_sefurlword_xref`
  ADD PRIMARY KEY (`word`,`url`);

--
-- Indexes for table `bc73q_sefwords`
--
ALTER TABLE `bc73q_sefwords`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `bc73q_sef_statistics`
--
ALTER TABLE `bc73q_sef_statistics`
  ADD PRIMARY KEY (`url_id`);

--
-- Indexes for table `bc73q_sef_subdomains`
--
ALTER TABLE `bc73q_sef_subdomains`
  ADD PRIMARY KEY (`subdomain`,`lang`);
...
--
ALTER TABLE `bc73q_acymailing_mail`
  MODIFY `mailid` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `bc73q_acymailing_subscriber`
  MODIFY `subid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `bc73q_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=917;
...
--
ALTER TABLE `bc73q_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10380;
...
--
ALTER TABLE `bc73q_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=643;
...
--
ALTER TABLE `bc73q_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=277340;
...
--
-- AUTO_INCREMENT for table `bc73q_gsd`
--
ALTER TABLE `bc73q_gsd`
...
--
-- AUTO_INCREMENT for table `bc73q_plg_easyfrontendseo`
--
ALTER TABLE `bc73q_plg_easyfrontendseo`
...
--
-- AUTO_INCREMENT for table `bc73q_sefaliases`
--
ALTER TABLE `bc73q_sefaliases`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bc73q_sefexts`
--
ALTER TABLE `bc73q_sefexts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bc73q_sefexttexts`
--
ALTER TABLE `bc73q_sefexttexts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bc73q_seflog`
--
ALTER TABLE `bc73q_seflog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `bc73q_sefmoved`
--
ALTER TABLE `bc73q_sefmoved`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `bc73q_sefurls`
--
ALTER TABLE `bc73q_sefurls`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=260;

--
-- AUTO_INCREMENT for table `bc73q_sefwords`
--
ALTER TABLE `bc73q_sefwords`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `bc73q_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `bc73q_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
